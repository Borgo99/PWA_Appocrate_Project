...
#ifndef WKWEBVIEWTEST_SWIFT_H
#define WKWEBVIEWTEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WKWebViewTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13WKWebViewTest13SceneDelegate")
...
@interface ViewController (SWIFT_EXTENSION(WKWebViewTest)) <WKScriptMessageHandler>
